...
function FreeboardModel(a, b, c) {
    ...
    this.datasourceTypes = ko.computed({
        read: function() {
            ...
            return _.each(a, function(a) {
                var c = a.type_name
                  , d = c;
                _.isUndefined(a.display_name) || (d = a.display_name),
                b.push({
                    name: c,
                    display_name: d
                })
    ...
    this.widgetTypes = ko.computed({
        read: function() {
            ...
            return _.each(b, function(b) {
                var c = b.type_name
                  , d = c;
                _.isUndefined(b.display_name) || (d = b.display_name),
                a.push({
                    name: c,
                    display_name: d
                })
    ...
    this.deserialize = function(e, f) {
        function g() {
            ...
            _.isUndefined(e.allow_edit) ? d.allow_edit(!0) : d.allow_edit(e.allow_edit),
            ...
            d.allow_edit() && 0 == d.panes().length && d.setEditing(!0),
            _.isFunction(f) && f(),
            c.processResize(!0)
        }
        d.clearDashboard(),
    ...
    this.saveDashboardClicked = function() {
        ...
        b ? $(event.currentTarget).siblings("label").fadeOut("slow") : $(event.currentTarget).siblings("label").fadeIn("slow"),
        a.data("siblings-shown", !b)
    }
    ,
    ...
    this.deleteDatasource = function(a) {
        delete d.datasourceData[a.name()],
        a.dispose(),
        d.datasources.remove(a)
    }
    ,
    ...
    this.setEditing = function(a, b) {
        if (d.allow_edit() || !a) {
            ...
            c.enableGrid()) : ($("#toggle-header-icon").addClass("icon-wrench").removeClass("icon-chevron-up"),
            $(".gridster .gs_w").css({
                cursor: "default"
            }),
            $("#main-header").animate({
...
function FreeboardUI() {
    function a(a) {
        ...
        a && (c = function(a) {
            var c = this
              , d = ko.dataFor(c)
              , e = q(d);
            $(c).attr("data-sizex", Math.min(d.col_width(), b, r.cols)).attr("data-row", e.row).attr("data-col", e.col),
            d.processSizeChange()
        }
        ),
        f(Math.min(b, w)),
    ...
    function b(a) {
        var b = r.cols + 1;
        f(b) && g(function() {
            var b, c = this, d = ko.dataFor(c), e = r.cols > 1 ? r.cols - 1 : 1, f = d.col[e], g = d.row[e];
            if (a) {
                leftPreviewCol = !0;
    ...
    function c(a) {
        var b = r.cols - 1;
        f(b) && g(function() {
            var b, c = this, d = ko.dataFor(c), e = r.cols + 1, f = d.col[e], g = d.row[e];
            if (a) {
                var h = f > 1 ? f - 1 : 1;
                b = {
                    row: g,
    ...
    function d() {
        var a = $(".column-tool")
          ...
          , c = Math.floor(b / v);
        r.cols <= u ? a.addClass("min") : a.removeClass("min"),
        r.cols >= c ? a.addClass("max") : a.removeClass("max")
    }
    function e() {
    ...
    function f(a) {
        ...
        a > b && (a = b);
        var c = v * a + a;
        return $(".responsive-column-width").css("max-width", c),
        a === r.cols ? !1 : !0
    }
    function g(a) {
        var b = r.$el;
        ...
        b.find("> li").each(a),
        r.init(),
        $(".responsive-column-width").css("width", r.cols * t + r.cols * s * 2)
    }
    function h() {
        return w
    }
    ...
    function l(a, b, c) {
        var d = r.cols;
        _.isUndefined(b) || (a.row[d] = b),
        _.isUndefined(c) || (a.col[d] = c)
    }
    function m(a) {
    ...
    function n(a, b) {
        _.isUndefined(b) && (b = !0);
        var c = b ? 250 : 0;
        a ? ($(".pane-tools").fadeIn(c),
        $("#column-tools").fadeIn(c)) : ($(".pane-tools").fadeOut(c),
        $("#column-tools").fadeOut(c))
    }
    function o(a) {
        $(a).hover(function() {
            p(this, !0)
    ...
    var r, s = 10, t = 300, u = 3, v = s + t + s, w = u, x = $('<div class="wrapperloading"><div class="loading up" ></div><div class="loading down"></div></div>');
...
function WidgetModel(a, b) {
    ...
    this.type.subscribe(function(a) {
        ...
        if (c(),
        a in b && _.isFunction(b[a].newInstance)) {
            var f = b[a];
    ...
    this.settings.subscribe(function(a) {
        !_.isUndefined(d.widgetInstance) && _.isFunction(d.widgetInstance.onSettingsChanged) && d.widgetInstance.onSettingsChanged(a),
    ...
    this.updateCalculatedSettings = function() {
        if (d.datasourceRefreshNotifications = {},
            ...
            _.each(a, function(a) {
                if ("calculated" == a.type) {
                    ...
                    if (!_.isUndefined(b)) {
                        ...
                        d.calculatedSettingScripts[a.name] = f,
                        d.processCalculatedSetting(a.name);
                        for (var i; i = c.exec(b); ) {
                            var j = i[1] || i[2]
                              , k = d.datasourceRefreshNotifications[j];
                            _.isUndefined(k) && (k = [],
                            d.datasourceRefreshNotifications[j] = k),
                            -1 == _.indexOf(k, a.name) && k.push(a.name)
                        }
                    }
                }
            })
    ...
    this.render = function(a) {
        d.shouldRender(!1),
        !_.isUndefined(d.widgetInstance) && _.isFunction(d.widgetInstance.render) && (d.widgetInstance.render(a),
        d.updateCalculatedSettings())
    }
    ,
    this.dispose = function() {}
...
DatasourceModel = function(a, b) {
    function c() {
        _.isUndefined(d.datasourceInstance) || (_.isFunction(d.datasourceInstance.onDispose) && d.datasourceInstance.onDispose(),
        d.datasourceInstance = void 0)
    }
    var d = this;
...
DeveloperConsole = function(a) {
    function b() {
        function b(a) {
            ...
            a && e.val(a),
            d.append(f),
            g.append(b.append($("<td></td>").append(e)).append($('<td class="table-row-operation">').append(d)))
        }
        var c = []
          , d = $("<div></div>")
        ...
        var g = $("<tbody></tbody>");
        f.append(g),
        d.append($("<p>Here you can add references to other scripts to load datasource or widget plugins.</p>")).append(f).append(e).append('<p>To learn how to build plugins for freeboard, please visit <a target="_blank" href="http://freeboard.github.io/freeboard/docs/plugin_example.html">http://freeboard.github.io/freeboard/docs/plugin_example.html</a></p>'),
        ...
        new DialogBox(d,"Developer Console","OK",null,function() {
            ...
            _.each(c, function(b) {
                var c = b.val();
                c && c.length > 0 && (a.addPluginSource(c),
                head.js(c + "?" + Date.now()))
            })
        }
        )
...
PluginEditor = function(a, b) {
    ...
    function f(c, d, e, f, g) {
        ...
        var k = $('<li><i class="icon-plus icon-white"></i><label>DATASOURCE</label></li>').mousedown(function(a) {
            a.preventDefault(),
            $(h).val("").focus().insertAtCaret('datasources["').trigger("freeboard-eval")
        });
        i.append(k);
    ...
    function g(a, b, g, h, i) {
        function j(a, b) {
            ...
            return c.append('<div class="form-label"><label class="control-label">' + b + "</label></div>"),
            $('<div id="setting-value-container-' + a + '" class="form-value"></div>').appendTo(c)
        }
        function k(a, b, c) {
            _.each(a, function(a) {
                function d() {
                ...
                function e(b) {
                    var c = $("<tr></tr>").appendTo(p)
                      , e = {};
                    _.isArray(m.settings[a.name]) || (m.settings[a.name] = []),
                    ...
                    _.each(a.settings, function(a) {
                        ...
                        e[a.name] = f,
                        $('<input class="table-row-value" type="text">').appendTo(d).val(f).change(function() {
                            e[a.name] = $(this).val()
                        })
                    }),
                    c.append($('<td class="table-row-operation"></td>').append($('<ul class="board-toolbar"></ul>').append($("<li></li>").append($('<i class="icon-trash icon-white"></i>').click(function() {
                        ...
                        -1 != b && (m.settings[a.name].splice(b, 1),
                        c.remove(),
                        d())
                    }))))),
                ...
                case "array":
                    ...
                    _.each(a.settings, function(a) {
                        var b = a.name;
                        _.isUndefined(a.display_name) || (b = a.display_name),
                        $("<th>" + b + "</th>").appendTo(o)
                    }),
                    a.name in h && (q = h[a.name]),
                    $('<div class="table-operation text-button">ADD</div>').appendTo(i).click(function() {
                        var b = {};
                        _.each(a.settings, function(a) {
                            b[a.name] = ""
                        }),
                ...
                case "option":
                    ...
                    _.each(a.options, function(a) {
                        var b, c;
                        _.isObject(a) ? (b = a.name,
                        c = a.value) : b = a,
                        _.isUndefined(c) && (c = b),
                        _.isUndefined(t) && (t = c),
                        $("<option></option>").text(b).attr("value", c).appendTo(s)
                    }),
                    m.settings[a.name] = t,
                ...
                default:
                    ...
                    "calculated" == a.type) {
                        ...
                        if (a.name in h && s.val(h[a.name]),
                        b && a.typeahead_data_field && s.addClass("typeahead_data_field-" + a.typeahead_data_field),
                        b && a.typeahead_field) {
                            var y = [];
                            s.keyup(function(a) {
                            ...
                            s.change(function(d) {
                                ...
                                $.get(f, function(b) {
                                    ...
                                    $(s).autocomplete("option", "source", y),
                                    1 == b.length) {
                                        b = b[0];
                                        for (var d in b)
                ...
                _.isUndefined(a.suffix) || i.append($('<div class="input-suffix">' + a.suffix + "</div>")),
                _.isUndefined(a.description) || i.append($('<div class="setting-description">' + a.description + "</div>"))
            })
        }
        var l, m = {
            type: g,
            settings: {}
        }, n = $("<div></div>"), o = $('<div id="plugin-description"></div>').hide();
        n.append(o),
        new DialogBox(n,a,"Save","Cancel",function() {
            ...
            for (var a = 0; a < l.settings.length; a++) {
                ...
                if (b.required && (_.isUndefined(m.settings[b.name]) || "" == m.settings[b.name]))
                    return c(b.name, "This is required."),
                    !0;
                if ("integer" == b.type && m.settings[b.name] % 1 !== 0)
                    return c(b.name, "Must be a whole number."),
                    !0;
                if ("number" == b.type && !e(m.settings[b.name]))
                    return c(b.name, "Must be a number."),
                    !0
            }
            _.isFunction(i) && i(m)
        }
        ...
        if (q.length > 1) {
            ...
            p = $("<select></select>").appendTo($('<div class="styled-select"></div>').appendTo(r)),
            p.append($("<option>Select a type...</option>").attr("value", "undefined")),
            _.each(b, function(a) {
            ...
            p.change(function() {
                ...
                d(),
                l = b[p.val()],
                _.isUndefined(l) ? ($("#setting-row-instance-name").hide(),
                $("#dialog-ok").hide()) : ($("#setting-row-instance-name").show(),
                l.description && l.description.length > 0 ? o.html(l.description).show() : o.hide(),
                $("#dialog-ok").show(),
                k(l.settings, l.typeahead_source, l.typeahead_data_segment))
            })
        } else
            1 == q.length && (l = b[q[0]],
            m.type = l.type_name,
            m.settings = {},
            k(l.settings));
        p && (_.isUndefined(g) ? ($("#setting-row-instance-name").hide(),
...
ValueEditor = function(a) {
    ...
    function d(a, b) {
        ...
        c(n, b) || $(a).parent().append("<div class='validation-error'>This field expects an expression that evaluates to type " + b + ".</div>")
    }
    function e(a) {
        var b = ($(a).val().match(/\n/g) || []).length
    ...
    function g(b, c) {
        ...
        if (e = e.replace(String.fromCharCode(160), " "),
        f(e, a.datasources(), c),
        m.length > 0) {
            k || (k = $('<ul id="value-selector" class="value-dropdown"></ul>').insertAfter(b).width($(b).outerWidth() - 2).css("left", $(b).position().left).css("top", $(b).position().top + $(b).outerHeight() - 1)),
            k.empty(),
            k.scrollTop(0);
            var g = !0;
            l = 0,
            _.each(m, function(a, c) {
                var d = h(b, e, a, c);
                g && ($(d).addClass("selected"),
                g = !1)
            })
        } else
            d(b, c),
            $(b).next("ul#value-selector").remove(),
            k = null,
            l = -1
    }
    function h(a, b, c, d) {
        ...
        var f = $("<li>" + e + "</li>").appendTo(k).mouseenter(function() {
            ...
            var e = b.lastIndexOf("]");
            -1 != e ? $(a).replaceTextAt(e + 1, $(a).val().length, d) : $(a).insertAtCaret(d),
            n = c.entity,
            $(a).triggerHandler("mouseup")
        }).bind("freeboard-select", function() {
            $(this).parent().find("li.selected").removeClass("selected"),
            $(this).addClass("selected"),
            l = $(this).data("freeboard-optionIndex")
        });
        return f
    }
    function i(a, b) {
        $(a).addClass("calculated-value-input").bind("keyup mouseup freeboard-eval", function(c) {
            ...
            $(a).next("ul#value-selector").remove(),
            k = null,
            l = -1
            ...
            if (k)
                if (38 == a.keyCode || 40 == a.keyCode) {
                    a.preventDefault();
                    var b = $(k).find("li");
                    38 == a.keyCode ? l-- : 40 == a.keyCode && l++,
                    0 > l ? l = b.size() - 1 : l >= b.size() && (l = 0);
                    var c = $(b).eq(l);
                    c.trigger("freeboard-select"),
                    $(k).scrollTop($(c).position().top)
                } else
                    13 == a.keyCode && (a.preventDefault(),
                    -1 != l && $(k).find("li").eq(l).trigger("freeboard-insertValue"))
        })
    }
...
function(a) {
    function b() {
        ...
        return a.setAttribute("id", "target"),
        b
    }
    function c(b, c) {
        if (b) {
            ...
            if (c.attributeName.indexOf("style") >= 0) {
                ...
                c.attributeName = e[0],
                c.oldValue = d.style[e[1]],
                c.newValue = e[1] + ":" + this.prop("style")[a.camelCase(e[1])],
                d.style[e[1]] = c.newValue
            } else
                c.oldValue = d[c.attributeName],
                c.newValue = this.attr(c.attributeName),
                d[c.attributeName] = c.newValue;
    ...
    a.fn.attrchange = function(e) {
        ...
        if ("function" == typeof e ? f.callback = e : a.extend(f, e),
        f.trackValues && a(this).each(function(b, c) {
            for (var d, e = {}, b = 0, f = c.attributes, g = f.length; g > b; b++)
                d = f.item(b),
                e[d.nodeName] = d.value;
            ...
            var g = {
              ...
              , h = new d(function(b) {
                b.forEach(function(b) {
                    var c = b.target;
                    f.trackValues && (b.newValue = a(c).attr(b.attributeName)),
                    f.callback.call(c, b)
                })
            }
            );
        ...
        return b() ? this.on("DOMAttrModified", function(a) {
            ...
            a.attributeName = a.attrName,
            a.oldValue = a.prevValue,
            f.callback.call(this, a)
        }) : "onpropertychange"in document.body ? this.on("propertychange", function(b) {
            b.attributeName = window.event.propertyName,
            c.call(a(this), f.trackValues, b),
            f.callback.call(this, b)
        }) : this
    }
}(jQuery),
function(a) {
...
var freeboard = function() {
    ...
    return ko.bindingHandlers.pluginEditor = {
        init: function(a, f, g, i, j) {
            var k = ko.unwrap(f())
              ...
              , m = void 0
              , n = "";
            "datasource" == k.type ? (l = b,
            n = "Datasource") : "widget" == k.type ? (l = c,
            n = "Widget") : "pane" == k.type && (n = "Pane"),
            $(a).click(function(f) {
                if ("delete" == k.operation) {
                    ...
                    var j = void 0;
                    "datasource" == k.type ? "add" == k.operation ? m = {} : (j = i.type(),
                    m = i.settings(),
                    m.name = i.name()) : "widget" == k.type ? "add" == k.operation ? m = {} : (j = i.type(),
                    m = i.settings()) : "pane" == k.type && (m = {},
                    "edit" == k.operation && (m.title = i.title(),
                    m.col_width = i.col_width()),
                    l = {
                        settings: {
                            settings: [{
                                name: "title",
                    ...
                    h.createPluginEditor(n, l, j, m, function(f) {
                        if ("add" == k.operation) {
                            if ("datasource" == k.type) {
                                ...
                                g.type(f.type),
                                i.widgets.push(g),
                                d.attachWidgetEditIcons(a)
                            }
                        } else
                            "edit" == k.operation && ("pane" == k.type ? (i.title(f.settings.title),
                            i.col_width(f.settings.col_width),
                            d.processResize(!1)) : ("datasource" == k.type && (i.name(f.settings.name),
                            delete f.settings.name),
                            i.type(f.type),
                            i.settings(f.settings)))
                    })
                }
            })
        }
    ...
    ko.bindingHandlers.pane = {
        ...
        update: function(a, b, c, f, g) {
            -1 == e.panes.indexOf(f) && d.removePane(a),
            d.updatePane(a, f)
        }
    },
    ...
    }),
    {
        ...
        loadDatasourcePlugin: function(a) {
            _.isUndefined(a.display_name) && (a.display_name = a.type_name),
            a.settings.unshift({
                name: "name",
                display_name: "Name",
                type: "text",
        ...
        loadWidgetPlugin: function(a) {
            ...
            e.addPluginSource(a.source),
            c[a.type_name] = a,
            e._widgetTypes.valueHasMutated()
        },
        ...
        addStyle: function(a, b) {
            var c = a + "{" + b + "}"
              , d = $("style#fb-styles");
            0 == d.length && (d = $('<style id="fb-styles" type="text/css"></style>'),
            $("head").append(d)),
            d[0].styleSheet ? d[0].styleSheet.cssText += c : d.text(d.text() + c)
        },
        showLoadingIndicator: function(a) {
...
function() {
    ...
    var d = function(a, b) {
        function c() {
            h.length > 0 ? (i < h.length && (b(h[i]),
            i++),
            i >= h.length && g.loop && (i = 0),
            i < h.length && (e = setTimeout(c, 1e3 * g.refresh))) : b({})
        }
        function d() {
            h = [],
            i = 0,
    ...
    var e = function(a, b) {
        ...
        function d() {
            c(),
            e = setInterval(f.updateNow, 1e3 * g.refresh)
        }
        var e, f = this, g = a;
        this.updateNow = function() {
            var a = new Date
...
function() {
    ...
    function c(a, b, c) {
        ...
        var i = function(a, b) {
            f[b] || (f[b] = []),
            f[b].length >= d && f[b].shift(),
            f[b].push(Number(a)),
            (void 0 === g || g > a) && (g = a),
            (void 0 === h || a > h) && (h = a)
        };
        _.isArray(b) ? _.each(b, i) : i(b, 0),
        $(a).data().values = f,
        $(a).data().valueMin = g,
        $(a).data().valueMax = h;
    ...
    freeboard.addStyle(".tw-value", f + "overflow: hidden;display: inline-block;text-overflow: ellipsis;"),
    ...
    var g = function(b) {
        ...
        this.render = function(a) {
            $(a).empty(),
            $(f).append($('<div class="tw-tr"></div>').append(g)).append($('<div class="tw-tr"></div>').append($('<div class="tw-value-wrapper tw-td"></div>').append(h).append(i))).append($('<div class="tw-tr"></div>').append(j)),
            $(a).append(f),
            d()
        }
        ,
        this.onSettingsChanged = function(a) {
            ...
            a.sparkline ? j.attr("style", null) : (delete j.data().values,
            j.empty(),
            j.hide()),
            b ? (g.html(_.isUndefined(a.title) ? "" : a.title),
            g.attr("style", null)) : (g.empty(),
            g.hide()),
            c ? (i.html(_.isUndefined(a.units) ? "" : a.units),
        ...
        this.onCalculatedValueChanged = function(b, d) {
            "value" == b && (e.animate ? a(d, h, 500) : h.text(d),
            e.sparkline && c(j, d))
        }
        ,
        this.onDispose = function() {}
    ...
    var i = function(a) {
        ...
        var c, d = "gauge-" + h++, e = $('<h2 class="section-title"></h2>'), f = $('<div class="gauge-widget" id="' + d + '"></div>'), g = !1, i = a;
        this.render = function(a) {
            g = !0,
            $(a).append(e).append($('<div class="gauge-widget-wrapper"></div>').append(f)),
            b()
        }
        ,
        this.onSettingsChanged = function(a) {
            a.min_value != i.min_value || a.max_value != i.max_value || a.units != i.units ? (i = a,
            b()) : i = a,
            e.html(a.title)
        }
        ,
    ...
    var k = function(a) {
        ...
        this.render = function(a) {
            ...
            d = c.path(b([e / 2, f / 2 - h + g, 15, 20, -30, 0])),
            d.attr("stroke-width", 0),
            d.attr("fill", "#fff"),
            $(a).append($('<div class="pointer-value"></div>').append(i).append(j))
        }
        ,
        this.onSettingsChanged = function(a) {
            j.html(a.units)
    ...
    var l = function(a) {
        ...
        this.onSettingsChanged = function(a) {
            b(),
            a.refresh && a.refresh > 0 && (e = setInterval(c, 1e3 * Number(a.refresh)))
        }
        ,
        this.onCalculatedValueChanged = function(a, b) {
            "src" == a && (f = b),
    ...
    var m = function(a) {
        function b() {
            g.toggleClass("on", i),
            i ? f.text(_.isUndefined(c) ? _.isUndefined(h.on_text) ? "" : h.on_text : c) : f.text(_.isUndefined(d) ? _.isUndefined(h.off_text) ? "" : h.off_text : d)
        }
        var c, d, e = $('<h2 class="section-title"></h2>'), f = $('<div class="indicator-text"></div>'), g = $('<div class="indicator-light"></div>'), h = a, i = !1;
        this.render = function(a) {
    ...
    var n = function(a) {
        ...
        this.render = function(a) {
            function e() {
                ...
                google.maps.event.addDomListener(a, "mouseenter", function(a) {
                    a.cancelBubble = !0,
                    c.hover || (c.hover = !0,
                    c.setOptions({
                        zoomControl: !0
